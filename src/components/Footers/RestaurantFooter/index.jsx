            ...
            <div className="clumn">
              <div className="flex">
                ...
                <div className="cont-flex">
                  ...
                  <span className="fz-16"><a href="#0">admin@cleanstarenergyusa.com</a></span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="copyrights d-flex justify-content-end">
                <p className="fz-13">© 2025 www.cleanstarenergyusa.com is Proudly Powered by <span className="underline"><a href="/#" rel="noreferrer" target="_blank" className="main-color">Clean Star Energy LLC</a></span></p>
              </div>
            </div>
          </div>
        </div>
